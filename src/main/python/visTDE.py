...
time_series = array_string_to_list_float(f.readline())[:-1]
...
plt.legend(bbox_to_anchor=(0., 1.22, 1, .102), loc='lower left', ncol=2, mode='expand', borderaxespad=0.)
