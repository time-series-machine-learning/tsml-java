...
//        hc.setupHIVE_COTE_0_1(); // approximation of original version (STC has changed
    ...
    public static void usageWithExperimentsClass() throws Exception {
        System.out.println(" the class src/main/java/experiments/ClassificationExperiments.java standardises the output of classifiers" +
                " to facilitate easy post processing" );
        System.out.println(" ClassificationExperiments.java allows for configuration  through command line arguments. Extensive " +
                "documentation on the possible configurations is at the top of the class" );
        System.out.println(" ClassificationExperiments.java creates a classifier based on switches in src/main/java/experiments/ClassifierLists.java" );
...
//Location of data set
        ...
        ClassificationExperiments.debug=true;
    ...
    public static void buildingFromComponents() throws Exception {
        ...
        System.out.printf(" Components results must be in the standard format, generated by ClassificationExperiments.java");
...
//Location of data set
    ...
    public static void contract() throws Exception {
        ...
        System.out.println(" these can be set through ClassificationExperiments or directly");
        HIVE_COTE hc = new HIVE_COTE();
