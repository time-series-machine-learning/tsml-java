...
//            index = random.nextInt(powersOf2.size() - 1) + 1;
    ...
    public void buildClassifier(Instances trainingData) throws Exception {
        ...
        for (; treeCount < numTrees && (System.nanoTime() - timer.forestStartTime) < (timer.forestTimeLimit - getTime()); treeCount++) {
            ...
            //System.out.println("Time taken (tree): " +  timer.dependantVaribles.get(timer.dependantVaribles.size()-1) + "     Interval length: " + (intervalInstances.numAttributes() - 1));
    ...
    public String getParameters() {
        ...
        for (int i = 0; i < timer.independantVaribles.size(); i++) {
            buildClassifierTime += timer.dependantVaribles.get(i);
        }
    ...
    private class Timer implements Serializable{
        ...
        protected double getFeatureSpace(long timeRemaining){
            ...
            //System.out.println("Time remaining (forest): " + y + "     Max interval length:" + x);
            return x;
        }
    ...
    public static void main(String[] args){
        ...
        //train = ClassifierTools.loadData("E:\\EqualTrainSubset\\EqualTrainSubset_TRAIN.arff");
        //test = ClassifierTools.loadData("E:\\EqualTrainSubset\\EqualTrainSubset_TEST.arff");
        ...
        //c.setStabilise(3);
        c.setModelOutPath("C:\\PhD\\Experiments\\cRISE\\Predictions\\CatsDogs");
        c.setSerializePath("C:\\PhD\\Experiments\\cRISE\\Predictions\\CatsDogs");
