...
public class cRotF
  ...
  public static void main(String [] argv) {
      Instances dataTrain = loadDataNullable("Z:/ArchiveData/Univariate_arff" + "/" + DatasetLists.newProblems27[0] + "/" + DatasetLists.newProblems27[0] + "_TRAIN");
      Instances dataTest = loadDataNullable("Z:/ArchiveData/Univariate_arff" + "/" + DatasetLists.newProblems27[0] + "/" + DatasetLists.newProblems27[0] + "_TEST");
      ...
      cRotF cRotF = null;
      ContractRotationForest conRotF = null;
      ...
      System.out.println();
      try {
          System.out.println("ContractRotationForest");
          conRotF = new ContractRotationForest();
          conRotF.setTrainTimeLimit(TimeUnit.MINUTES, (long)0.09851869645);
          cr = sse.evaluate(conRotF, data);
          System.out.println("Accuracy: " + cr.getAcc());
          System.out.println("Build time (ns): " + cr.getBuildTimeInNanos());
      } catch (Exception e) {
          e.printStackTrace();
