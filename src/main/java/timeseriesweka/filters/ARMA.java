...
import static timeseriesweka.filters.PACF.DEFAULT_MAXLAG;
import weka.filters.*;
...
/** 
  <!-- globalinfo-start -->
* Implementation of AR function as a Weka SimpleBatchFilter
...
//Get the class values as a fast vector			
    ...
    public Instances process(Instances inst) throws Exception {
        ...
        //For each data, first extract the relevant ..
...
/* This function verifies the output is the same as from R
