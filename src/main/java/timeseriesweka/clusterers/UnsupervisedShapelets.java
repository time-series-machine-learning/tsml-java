...
public class UnsupervisedShapelets extends AbstractTimeSeriesClusterer{
    ...
    public static void main(String[] args) throws Exception{
        ...
        Instances inst = DatasetLoading.loadData("Z:/Data/TSCProblems2018/" + dataset + "/" + dataset + "_TRAIN.arff");
        Instances inst2 = DatasetLoading.loadData("Z:/Data/TSCProblems2018/" + dataset + "/" + dataset + "_TEST.arff");
