 ...
 */
public class RandomBaggingBOSS extends AbstractClassifierWithTrainingData implements HiveCoteModule, TrainAccuracyEstimate, ContractClassifier, CheckpointClassifier {
    ...
    public void copyFromSerObject(Object obj) throws Exception{
        if(!(obj instanceof RandomBaggingBOSS))
            throw new Exception("The SER file is not an instance of RandomBOSS");
        RandomBaggingBOSS saved = ((RandomBaggingBOSS)obj);
        ...
        trainResults.setBuildTime(saved.trainResults.getBuildTime());
...
//TO DO: Write the other stats        
    ...
    public void buildClassifier(final Instances data) throws Exception {
        ...
        if (contract){
            while(System.nanoTime() - trainResults.getBuildTime() - checkpointTimeDiff < contractTime && classifiers.size() < 500){
                ...
                Instances samples = data.resample(rand);
                ...
                if (checkpoint && classifiers.size() % 10 == 0){
            ...
            System.out.println("RBOSS Contract Data: NumClassifiers = " + 
                    classifiers.size() + " StartTime = " + trainResults.getBuildTime() + " "
                    ...
                    + (System.nanoTime() - trainResults.getBuildTime() - checkpointTimeDiff)/classifiers.size());
        }
        else{
    ...
    public static void main(String[] args) throws Exception{
        ...
        Classifier c = new RandomBaggingBOSS();
    ...
    public static void detailedFold0Test(String dset) {
        ...
        try {
            ...
            RandomBaggingBOSS boss = new RandomBaggingBOSS();
