 ...
 */
public class RandomTreeBOSS extends AbstractClassifierWithTrainingData implements HiveCoteModule, TrainAccuracyEstimate, ContractClassifier, CheckpointClassifier {
    ...
    public void copyFromSerObject(Object obj) throws Exception{
        if(!(obj instanceof RandomTreeBOSS))
            throw new Exception("The SER file is not an instance of RandomBOSS");
        RandomTreeBOSS saved = ((RandomTreeBOSS)obj);
...
//TO DO: Write the other stats        
    ...
    public static void main(String[] args) throws Exception{
        ...
        Classifier c = new RandomTreeBOSS();
    ...
    public static void detailedFold0Test(String dset) {
        ...
        try {
            ...
            RandomTreeBOSS boss = new RandomTreeBOSS();
    ...
    public static class BOSSIndividual implements Classifier, Serializable {
        ...
        public void buildClassifier(Instances data) throws Exception {
            ...
            tree = new J48();
            tree.buildClassifier(histograms);   
        }
        ...
        public double classifyInstance(Instance instance) throws Exception {
            ...
            return tree.classifyInstance(test.firstInstance());
        }
