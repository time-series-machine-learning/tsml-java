 ...
 */
public class RandomBoostedBOSS extends AbstractClassifierWithTrainingData implements HiveCoteModule, TrainAccuracyEstimate, ContractClassifier, CheckpointClassifier {
    ...
    private ArrayList<Double> classifierWeights;
    ...
    public void copyFromSerObject(Object obj) throws Exception{
        if(!(obj instanceof RandomBoostedBOSS))
            throw new Exception("The SER file is not an instance of RandomBOSS");
        RandomBoostedBOSS saved = ((RandomBoostedBOSS)obj);
...
//TO DO: Write the other stats        
    ...
    public void buildClassifier(final Instances data) throws Exception {
        ...
        double initialWeight = 1.0/data.numInstances();
        //double initialWeight = 1.0;
        classifierWeights = new ArrayList();
        
        for (int i = 0; i < data.numInstances(); i++){
            data.get(i).setWeight(initialWeight);
        }
    ...
    private double[] trainPredictions(Instances data, BOSSIndividual c) throws Exception{
    ...
    private double trainError(Instances data, double[] predictions){
        double correctPreds = 0;
        ...
        return 1-(correctPreds/data.numInstances());
    }
...
//        System.out.println();
    ...
    public static void main(String[] args) throws Exception{
        ...
        Classifier c = new RandomBoostedBOSS();
    ...
    public static void detailedFold0Test(String dset) {
        ...
        try {
            ...
            RandomBoostedBOSS boss = new RandomBoostedBOSS();
