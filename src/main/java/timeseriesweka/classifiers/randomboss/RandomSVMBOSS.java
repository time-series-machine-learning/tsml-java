 ...
 */
public class RandomSVMBOSS extends AbstractClassifierWithTrainingData implements HiveCoteModule, TrainAccuracyEstimate, ContractClassifier, CheckpointClassifier {
    ...
    public void copyFromSerObject(Object obj) throws Exception{
        if(!(obj instanceof RandomSVMBOSS))
            throw new Exception("The SER file is not an instance of RandomBOSS");
        RandomSVMBOSS saved = ((RandomSVMBOSS)obj);
...
//TO DO: Write the other stats        
    ...
    public void buildClassifier(final Instances data) throws Exception {
        ...
        double[] gammas = {0.01, 0.1, 1, 10, 100};
        ...
        if (contract){
            while(System.nanoTime() - trainResults.buildTime - checkpointTimeDiff < contractTime && classifiers.size() < 500){
                ...
                int kernel = rand.nextInt(3);
                int confidence = rand.nextInt(5);
                int gamma = rand.nextInt(5);

                BOSSIndividual boss = new BOSSIndividual(wordLength, alphabetSize, winSize, normalise, kernel, cs[confidence], gammas[gamma]);
    ...
    public static void main(String[] args) throws Exception{
        ...
        Classifier c = new RandomSVMBOSS();
    ...
    public static void detailedFold0Test(String dset) {
        ...
        try {
            ...
            RandomSVMBOSS boss = new RandomSVMBOSS();
    ...
    public static class BOSSIndividual implements Classifier, Serializable {
        ...
        public BOSSIndividual(int wordLength, int alphabetSize, int windowSize, boolean normalise, int kernel, double confidence, double gamma) {
        ...
        public void buildClassifier(Instances data) throws Exception {
            ...
            svm.buildClassifier(histograms);   
        }
        ...
        public double classifyInstance(Instance instance) throws Exception {
            ...
            Instances test = new Instances(instance.dataset().relationName(), atts, 1);
            test.setClassIndex(test.numAttributes()-1);
            test.add(testHist);
            
            return svm.classifyInstance(test.firstInstance());
        }
        ...
        public double classifyInstance(int testIndex) throws Exception {
            ...
            Instance testHist = new DenseInstance(1, values);
            Instances test = new Instances("test", atts, 1);
            test.setClassIndex(test.numAttributes()-1);
            test.add(testHist);
        ...
        public static void detailedFold0Test(String dset) {
            ...
            try {
                ...
                BOSSIndividual boss = new BOSSIndividual(windowSize, alphabetSize, wordLength, norm, 1, 1, 1);
