 ...
 */
public class RandomCAWPEBOSS extends AbstractClassifierWithTrainingData implements HiveCoteModule, TrainAccuracyEstimate, ContractClassifier, CheckpointClassifier {
    ...
    public void copyFromSerObject(Object obj) throws Exception{
        if(!(obj instanceof RandomCAWPEBOSS))
            throw new Exception("The SER file is not an instance of RandomBOSS");
        RandomCAWPEBOSS saved = ((RandomCAWPEBOSS)obj);
...
//TO DO: Write the other stats        
    ...
    public void buildClassifier(final Instances data) throws Exception {
        ...
        BOSSIndividual[] boss = classifiers.toArray(new BOSSIndividual[classifiers.size()]);
        
        cawpe = new CAWPE();
        cawpe.setNumCVFolds(numCVFolds);
        cawpe.setClassifiers(boss, null, null);
        cawpe.buildClassifier(data);
...
//        return classHist;
        ...
        return cawpe.distributionForInstance(instance);
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        Classifier c = new RandomCAWPEBOSS();
    ...
    public static void detailedFold0Test(String dset) {
        ...
        try {
            ...
            RandomCAWPEBOSS boss = new RandomCAWPEBOSS();
    ...
    public static class BOSSIndividual implements Classifier, Serializable {
        ...
        public double[] distributionForInstance(Instance instance) throws Exception {
            ...
            int instClass = (int)classifyInstance(instance);
            dist[instClass] = 1;
