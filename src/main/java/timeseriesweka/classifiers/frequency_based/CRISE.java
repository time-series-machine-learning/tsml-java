...
//            }
 ...
 Dividing this by minNumtrees - treeCount gives the maximum space such that in the worse case the contract is met.
    ...
    public static void main(String[] args){
        ...
        train = DatasetLoading.loadData("Z:\\Data\\TSCProblems2018\\"+problemName+"\\"+problemName+"_TRAIN.arff");
        test = DatasetLoading.loadData("Z:\\Data\\TSCProblems2018\\"+problemName+"\\"+problemName+"_TEST.arff");
