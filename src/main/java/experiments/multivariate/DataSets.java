 ...
 */
package experiments.multivariate;
...
public class DataSets {
    ...
    public static void createAndWriteSummaryStats(boolean findStats) throws Exception{
        ...
        for(String dataset : experiments.multivariate.DataSets.arransList){
            ...
            Instances test;
            try {
                train = DatasetLoading.loadDataThrowable(new File(experiments.multivariate.DataSets.dropboxPath + dataset + "/" + dataset +"_TRAIN.arff"));
                test = DatasetLoading.loadDataThrowable(new File(experiments.multivariate.DataSets.dropboxPath + dataset + "/" + dataset +"_TEST.arff"));
