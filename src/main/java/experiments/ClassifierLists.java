...
//HC 2 variants
     ...
     * BESPOKE classifiers for particular set ups. Use if you want some special configuration/pipeline
     * not encapsulated within a single classifier      */
    public static String[] earlyClassification= {"TEASER","ECEC","eSTC",
            "P85-CIF","P85c3-CIF","TEASER-CIF","SR1CF1-CIF","ECEC-CIF","P85-DrCIF","P85c3-DrCIF","TEASER-DrCIF","SR1CF1-DrCIF","ECEC-DrCIF","P85-TDE","P85c3-TDE","TEASER-TDE",
            "SR1CF1-TDE","ECEC-TDE","P85-STC","P85c3-STC","TEASER-STC","SR1CF1-STC","ECEC-STC","P85-ROCKET","P85c3-ROCKET","TEASER-ROCKET","SR1CF1-ROCKET","ECEC-ROCKET",
            "P85-catch22","P85c3-catch22","TEASER-catch22","SR1CF1-catch22","ECEC-catch22","P85-TSF","P85c3-TSF","TEASER-TSF","SR1CF1-TSF","ECEC-TSF","P85-RISE","P85c3-RISE",
            "TEASER-RISE","SR1CF1-RISE","ECEC-RISE","P85-Arsenal","P85c3-Arsenal","TEASER-Arsenal","SR1CF1-Arsenal","ECEC-Arsenal","P85-cBOSS","P85c3-cBOSS","TEASER-cBOSS",
            "SR1CF1-cBOSS","ECEC-cBOSS","P85-HC1","P85c3-HC1","TEASER-HC1","SR1CF1-HC1","ECEC-HC1","P85-HC2","P85c3-HC2","TEASER-HC2","SR1CF1-HC2","ECEC-HC2","P85-DTWCV",
            "P85c3-DTWCV","TEASER-DTWCV","SR1CF1-DTWCV","ECEC-DTWCV","P85-WEASEL","P85c3-WEASEL","TEASER-WEASEL","SR1CF1-WEASEL","ECEC-WEASEL"
    };
    ...
    private static Classifier setEarlyClassifiers(ExperimentalArguments exp){
        ...
        switch(classifier) {
            ...
            case "P85-HC2":
                ...
                break;
            case "P85-DTWCV":
                c = new EarlyDecisionMakerClassifier(new DTWCV(), new ProbabilityThreshold());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;
            case "P85-WEASEL":
                c = new EarlyDecisionMakerClassifier(new WEASEL(), new ProbabilityThreshold());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;
            ...
            case "TEASER-CIF":
                c = new EarlyDecisionMakerClassifier(new CIF(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "CIF/Predictions/" + dataset + "/");
                break;
            case "TEASER-DrCIF":
            ...
            case "TEASER-catch22":
                ...
                break;
            case "TEASER-TSF":
                c = new EarlyDecisionMakerClassifier(new TSF(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "TSF/Predictions/" + dataset + "/");
                break;
            case "TEASER-RISE":
                c = new EarlyDecisionMakerClassifier(new RISE(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "RISE/Predictions/" + dataset + "/");
                break;
            case "TEASER-Arsenal":
                c = new EarlyDecisionMakerClassifier(new Arsenal(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "Arsenal/Predictions/" + dataset + "/");
                break;
            case "TEASER-cBOSS":
                c = new EarlyDecisionMakerClassifier(new cBOSS(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "cBOSS/Predictions/" + dataset + "/");
                break;
            case "TEASER-HC1":
            ...
            case "TEASER-HC2":
                ...
                break;
            case "TEASER-DTWCV":
                c = new EarlyDecisionMakerClassifier(new DTWCV(), new TEASER());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;
            case "TEASER-WEASEL":
                c = new EarlyDecisionMakerClassifier(new WEASEL(), new TEASER());
            ...
            case "SR1CF1-CIF":
                c = new EarlyDecisionMakerClassifier(new CIF(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "CIF/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-DrCIF":
            ...
            case "SR1CF1-catch22":
                ...
                break;
            case "SR1CF1-TSF":
                c = new EarlyDecisionMakerClassifier(new TSF(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "TSF/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-RISE":
                c = new EarlyDecisionMakerClassifier(new RISE(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "RISE/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-Arsenal":
                c = new EarlyDecisionMakerClassifier(new Arsenal(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "Arsenal/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-cBOSS":
                c = new EarlyDecisionMakerClassifier(new cBOSS(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "cBOSS/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-HC1":
                c = new EarlyDecisionMakerClassifier(new HIVE_COTE(), new SR1CF1());
                ((HIVE_COTE) ((EarlyDecisionMakerClassifier) c).getClassifier()).setupHIVE_COTE_1_0();
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC1/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-HC2":
                ...
                break;
            case "SR1CF1-DTWCV":
                c = new EarlyDecisionMakerClassifier(new DTWCV(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;
            case "SR1CF1-WEASEL":
                c = new EarlyDecisionMakerClassifier(new WEASEL(), new SR1CF1());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;

            case "ECEC-CIF":
                c = new EarlyDecisionMakerClassifier(new CIF(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "CIF/Predictions/" + dataset + "/");
                break;
            case "ECEC-DrCIF":
                ...
                break;
            case "ECEC-TDE":
                c = new EarlyDecisionMakerClassifier(new TDE(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "TDE/Predictions/" + dataset + "/");
                break;
            case "ECEC-STC":
                c = new EarlyDecisionMakerClassifier(new ShapeletTransformClassifier(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "STC/Predictions/" + dataset + "/");
                break;
            case "ECEC-ROCKET":
                c = new EarlyDecisionMakerClassifier(new ROCKETClassifier(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "ROCKET/Predictions/" + dataset + "/");
                break;
            case "ECEC-catch22":
                c = new EarlyDecisionMakerClassifier(new Catch22Classifier(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "catch22/Predictions/" + dataset + "/");
                break;
            case "ECEC-TSF":
                c = new EarlyDecisionMakerClassifier(new TSF(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "TSF/Predictions/" + dataset + "/");
                break;
            case "ECEC-RISE":
                c = new EarlyDecisionMakerClassifier(new RISE(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "RISE/Predictions/" + dataset + "/");
                break;
            case "ECEC-Arsenal":
                c = new EarlyDecisionMakerClassifier(new Arsenal(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "Arsenal/Predictions/" + dataset + "/");
                break;
            case "ECEC-cBOSS":
                c = new EarlyDecisionMakerClassifier(new cBOSS(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "cBOSS/Predictions/" + dataset + "/");
                break;
            case "ECEC-HC1":
                c = new EarlyDecisionMakerClassifier(new HIVE_COTE(), new ECEC());
                ((HIVE_COTE) ((EarlyDecisionMakerClassifier) c).getClassifier()).setupHIVE_COTE_1_0();
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC1/Predictions/" + dataset + "/");
                break;
            case "ECEC-HC2":
                ...
                break;
            case "ECEC-DTWCV":
                c = new EarlyDecisionMakerClassifier(new DTWCV(), new ECEC());
                //((EarlyDecisionMakerClassifier) c).setLoadFromFilePath(resultsPath + "HC2/Predictions/" + dataset + "/");
                break;
            case "ECEC-WEASEL":
                c = new EarlyDecisionMakerClassifier(new WEASEL(), new ECEC());
