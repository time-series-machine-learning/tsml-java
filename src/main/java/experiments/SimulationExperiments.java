...
import tsml
        .classifiers.dictionary_based.*;
import tsml
        .classifiers.distance_based.DTWCV;
import tsml
        .classifiers.hybrids.FlatCote;
import tsml
        .classifiers.shapelet_based.LearnShapelets;
import tsml
        .classifiers.shapelet_based.FastShapelets;
import tsml
        .classifiers.interval_based.TSBF;
import tsml
        .classifiers.interval_based.TSF;
import tsml
        .classifiers.distance_based.DTD_C;
import tsml
        .classifiers.shapelet_based.ShapeletTransformClassifier;
import tsml
        .classifiers.interval_based.LPS;
import tsml
        .classifiers.distance_based.ElasticEnsemble;
import tsml
        .classifiers.distance_based.DD_DTW;
import tsml
        .classifiers.hybrids.HiveCote;
...
import tsml
        .classifiers.EnhancedAbstractClassifier;
...
import tsml
        .classifiers.distance_based.elastic_ensemble.DTW1NN;
import tsml
        .filters.MatrixProfile;
import weka.core.Instances;
import utilities.ClassifierTools;
import machine_learning.classifiers.kNN;
import weka.core.Instance;
import tsml
        .filters.NormalizeCase;
...
//            DatasetLists.resultsPath="C:\\Users\\ajb\\Dropbox\\Results\\MatrixProfileExperiments\\";
    ...
    public static void dictionarySimulatorChangingTrainSize() throws Exception {
        ...
        for(int trainSize=500;trainSize<=10000;trainSize+=500) {
            ...
            long t1, t2;
            String[] classifierNames = {"cBOSS", "WEASEL"};
    ...
    public static void dictionarySimulatorChangingSeriesLength() throws Exception {
        ...
        for(int seriesLength=500;seriesLength<=10000;seriesLength+=500) {
            ...
            System.out.println(" Generating simulated data ....");
            int[] casesPerClass = new int[2];
            casesPerClass[0] = casesPerClass[1] = 50;
            int[] shapesPerClass = new int[]{5, 20};
            long t1, t2;
    ...
    public static void catch22SimulatorChangingTrainSize() throws Exception {
        ...
        for(int trainSize=1200;trainSize<= 1200;trainSize+=100) {
            ...
            path.mkdirs();
            if(!overwrite) {
                File f1 = new File(writePath + "Catch22TrainSize" + trainSize + "/testAcc" + trainSize + ".csv");
                File f2 = new File(writePath + "Catch22TrainSize" + trainSize + "/trainTime" + trainSize + ".csv");
