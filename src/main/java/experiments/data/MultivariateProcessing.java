...
import weka.core.Instances;
    ...
    public class MultivariateProcessing {
        ...
        public static void makeConcatenatedFiles(){
            ...
            for(String prob: DatasetLists.mtscProblems2018){
                ...
                if(!(t1.exists()||t2.exists())){
                    ...
                    train =DatasetLoading.loadData(dest+prob+"\\"+prob+"_TRAIN");
                    System.out.println("Can load univariate "+dest+prob+"\\"+prob+"_TRAIN");
                    test =DatasetLoading.loadData(dest+prob+"\\"+prob+"_TEST");
        ...
        public static Instances[] convertToUnivariate(String path, String dest, String prob){
            ...
            //            System.out.println(" Object type ="+x);
            Instances train =DatasetLoading.loadData(dest+prob+"_UNI"+"/"+prob+"_UNI_TRAIN");
            System.out.println("Can load univariate "+dest+prob+"_UNI"+"/"+prob+"_UNI_TRAIN");
            Instances test =DatasetLoading.loadData(dest+prob+"_UNI"+"/"+prob+"_UNI_TEST");
...
//            System.out.println(" Object type ="+x);
                try{
                    Instances train =DatasetLoading.loadData(dest+prob+"\\"+prob+"_TRAIN");
                    System.out.println("Can load univariate "+dest+prob+"\\"+prob+"_TRAIN");
                }catch(Exception e){
                ...
                try{
                    Instances test =DatasetLoading.loadData(dest+prob+"\\"+prob+"_TEST");
                    System.out.println("Can load univariate "+dest+prob+"\\"+prob+"_TEST");
                }catch(Exception e){
...
//        Instances temp=DatasetLoading.loadData("C:\\Users\\ajb\\Dropbox\\Data\\Multivariate TSC Problems\\FinalUni");
...
//        Instances mtsc=MultivariateInstanceTools.convertUnivariateToMultivariate(temp,30);
            ...
            Instances test=DatasetLoading.loadData("C:\\Users\\ajb\\Dropbox\\Data\\Multivariate TSC Problems\\RacketSports.arff");
...
//            System.out.println(" Object type ="+x);
        ...
        public static void formatSelfRegulationSCP1() throws Exception {
            ...
            arff.closeFile();
            Instances temp=DatasetLoading.loadData(path+"SelfRegulationSCP1Uni_TRAIN.arff");
            ...
            temp=DatasetLoading.loadData(path+"SelfRegulationSCPUni_TEST.arff");
        ...
        public static void formatSelfRegulationSCP2() throws Exception {
            ...
            arff.closeFile();
            Instances temp=DatasetLoading.loadData(path+"SelfRegulationSCP2Uni_TRAIN.arff");
            ...
            temp=DatasetLoading.loadData(path+"SelfRegulationSCP2Uni_TEST.arff");
        ...
        public static void formatFingerMovements() throws Exception {
            ...
            Instances temp=DatasetLoading.loadData(path+"FingerMovementsUni_TRAIN.arff");
            Instances multi=MultivariateInstanceTools.convertUnivariateToMultivariate(temp,m);
            System.out.println("Num instances "+multi.numInstances());
            System.out.println("Num atts "+multi.numAttributes());
            ...
            temp=DatasetLoading.loadData(path+"FingerMovementsUni_TEST.arff");
            multi=MultivariateInstanceTools.convertUnivariateToMultivariate(temp,m);
            System.out.println("Num instances "+multi.numInstances());
            System.out.println("Num atts "+multi.numAttributes());
...
//Labels in a separate text file
            ...
            arffTrain.closeFile();
            Instances tr=DatasetLoading.loadData(arffP);
            ...
            arffTest.closeFile();
            Instances te=DatasetLoading.loadData(arffP2);
