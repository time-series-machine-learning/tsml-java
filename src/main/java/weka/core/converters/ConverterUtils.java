...
public class ConverterUtils
  ...
  /** the core loaders - hardcoded list necessary for RMI/Remote ClassificationExperiments
...
//    + weka.core.converters.DatabaseConverter.class.getName() + ","
  ...
  /** the core savers - hardcoded list necessary for RMI/Remote ClassificationExperiments
   * (comma-separated list). */
