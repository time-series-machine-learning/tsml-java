...
public class MoodsMedianTreeWithInfoGain extends AbstractClassifier{

    private ShapeletNode root;
    private String logFileName;
    private int minLength, maxLength;
    
    public MoodsMedianTreeWithInfoGain(String logFileName) throws Exception {
...
//            double median = getMedian(orderline);
