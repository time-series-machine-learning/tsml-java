...
/**** Checkpointing variables *****/
     ...
     * @param seed
     */
    public RISE_FisherProxy(long seed){
 ...
 identifier.
    ...
    private RISE_FisherProxy readSerialise(long seed){
        ObjectInputStream oi = null;
        RISE_FisherProxy temp = null;
        try {
            ...
            temp = (RISE_FisherProxy)oi.readObject();
            oi.close();
            fi.close();
            System.out.println("File load successful: " + ((RISE_FisherProxy)temp).classifiersBuilt + " trees.");
    ...
    public void copyFromSerObject(Object temp){
        RISE_FisherProxy riseKNNProxy;
        try{
            riseKNNProxy =(RISE_FisherProxy)temp;
        }catch(Exception ex){
...
//                        checkpoint(startTime);
    ...
    private void estimateOwnPerformance(Instances data) throws Exception{
        ...
        if(estimator==EstimatorMethod.OOB) {
            ...
            RISE_FisherProxy riseKNNProxy = new RISE_FisherProxy();
