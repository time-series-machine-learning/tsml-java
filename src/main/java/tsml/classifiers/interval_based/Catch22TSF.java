 ...
 *
 * *** EXPERIMENTAL ***
 * TSF with Catch22 features. original tsf comment stuff below :)
 * changes by Matthew Middlehurst
 *
 <!-- globalinfo-start -->
...
//        tsf.writeTrainEstimatesToFile(resultsLocation+problem+"trainFold0.csv");
        ...
        System.out.println(tsf.trainResults.getAcc());
