...
public class DTWDistanceTest {
    ...
    public static class OrigImplementations {
...
*/
    ...
    public static class TestOnDatasets {
        ...
        public DistanceMeasureSpaceBuilder getBuilder() {
        ...
        public void test() throws Exception {
            ...
            final String testDistancesFilePath = "src/main/java/" + getClass().getPackage().getName().replaceAll("\\.", "/") + "/test_data/" + name + "_" + datasetName + ".csv";
            ...
            final String path = Arrays.asList(BAKED_IN_MTSC_DATASETS).contains(datasetName) ? BAKED_IN_MTSC_DATA_PATH : BAKED_IN_TSC_DATA_PATH;
            final int seed = 0;
                    ...
                    if(BAKED_IN_TSC_DATA_PATH.equals(path)) {
                        ...
                        switch(name) {
                            case "LCSS":
                                ...
                                v = OrigImplementations.origLcss(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
                                        (int) Math.ceil(((LCSSDistance) distanceMeasure).getWindowSize() * inst1.getMaxLength()),
                                        ((LCSSDistance) distanceMeasure).getEpsilon());
                                break;
                            case "DDTW":
                                v = OrigImplementations.origDtw(Converter.toArff(new Derivative().transform(inst1)), Converter.toArff(new Derivative().transform(inst2)),
                                        Double.POSITIVE_INFINITY,
                                        rawWindow);
                                ...
                                break;
                            case "WDDTW":
                                v = OrigImplementations.origWdtw(Converter.toArff(new Derivative().transform(inst1)), Converter.toArff(new Derivative().transform(inst2)),
                                        Double.POSITIVE_INFINITY,
                                        ((WDTWDistance) ((TransformDistanceMeasure) distanceMeasure).getDistanceMeasure()).getG());
                                u = distanceMeasure.distance(inst1, inst2);
                                break;
                            case "DTW":
                                v = OrigImplementations.origDtw(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
                                        rawWindow);
                                ...
                                break;
                            case "WDTW":
                                v = OrigImplementations.origWdtw(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
                                        ((WDTWDistance) distanceMeasure).getG());
                                u = distanceMeasure.distance(inst1, inst2);
                                break;
                            case "ERP":
                                v = OrigImplementations.origErp(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
                                ...
                                break;
                            case "MSM":
                                v = OrigImplementations.origMsm(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
                                        ((MSMDistance) distanceMeasure).getC());
                                u = distanceMeasure.distance(inst1, inst2);
                                break;
                            case "TWED":
                                v = OrigImplementations.origTwed(Converter.toArff(inst1), Converter.toArff(inst2),
                                        Double.POSITIVE_INFINITY,
