 ...
 ******************************************************************************/
package tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.windowSearcher;

import java.util.ArrayList;
import java.util.Collections;

import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.items.LazyAssessNN;
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.items.SequenceStatsCache;
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.items.LazyAssessNN.RefineReturnType;
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.sequences.SymbolicSequence;
 ...
 *
 */
public class FastWWSPrunedDTW extends WindowSearcher {
	// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
    // Internal types
    // --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
	/**
    ...
    // Constructor
    // --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
    public FastWWSPrunedDTW() {
        super();
        forwardSearch = false;
        init = false;
    }
    
    public FastWWSPrunedDTW(String name) {
        super();
        forwardSearch = false;
        init = false;
        datasetName = name;
    ...
    protected void initTable() {
        ...
        for(int current=1; current < train.length; ++current){
            ...
            // --- --- First do full window using PrunedDTW
            // Currently compute UB on the go for PrunedDTW
            // Could have done Euclidean Distance first then use Euclidean Distance as the UB
            int win = maxWindow;
            ...
            if(currPNN.isNN()){
                ...
                for(int previous = 0; previous < current; ++previous){
                    ...
                    // Used PrunedDTW instead of DTW here
                    RefineReturnType rrt = challenger.tryToBeatPrunedDTW(toBeat, win);	
                ...
                for (LazyAssessNN challenger : challengers) {
                    ...
                    rrt = challenger.tryToBeatPrunedDTW(toBeat, win);
            ...
            for(win=maxWindow-1; win>-1; --win){
                // --- Get the data
                currPNN = nns[win][current];
