...
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.windowSearcher.UCRSuitePrunedDTW;

/**
 * Code for the paper "Efficient search of the best warping window for Dynamic Time Warping" published in SDM18
 * 
 * Experiment to search for the best warping window using KDD12 + SDM16 method
 * 
 * KDD12 paper:
 ...
 *
 */
public class UCR_UCRSuitePrunedDTW {
	...
	public static void main(String[] args) throws Exception {
		...
		method = "UCRSuite-PrunedDTW";	// Method type in finding the best window
