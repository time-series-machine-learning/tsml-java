...
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.tools.UCRArchive;
import weka.classifiers.Evaluation;
import weka.core.Instances;
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.windowSearcher.UCRSuite;
 ...
 * but using Lazy UCR Suite instead of the original algorithm 
 * 
 * KDD12 paper:
...
public class UCR_UCRSuite {
	...
	public static void main(String[] args) throws Exception {
		...
		method = "UCRSuite";					// Method type in finding the best window
	...
	private static void singleProblem (String datasetName) throws Exception {
     ...
     // Go through different runs and randomize the dataset
        for (int i = 0; i < nbRuns; i++) {
        	...
        	UCRSuite classifier = new UCRSuite(datasetName);
