...
import tsml.classifiers.distance_based.legacy.elastic_ensemble.fast_window_search.windowSearcher.NaiveDTW;

/**
 * Code for the paper "Efficient search of the best warping window for Dynamic Time Warping" published in SDM18
 * 
 * Experiment to search for the best warping window using Naive DTW method
 * 
 * @author Chang Wei Tan
 *
 */
public class UCR_NaiveDTW {
	...
	private static void singleProblem (String datasetName) throws Exception {
        ...
        for (int i = 0; i < nbRuns; i++) {
        	...
        	NaiveDTW classifier = new NaiveDTW(datasetName);
