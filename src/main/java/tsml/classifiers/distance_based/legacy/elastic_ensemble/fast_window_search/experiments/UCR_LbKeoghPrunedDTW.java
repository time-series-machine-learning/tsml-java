 ...
 * 
 * Experiment to search for the best warping window using SDM16 method
 * 
 * SDM16 paper: 
 ...
 *
 */
public class UCR_LbKeoghPrunedDTW {
	...
	public static void main(String[] args) throws Exception {
		...
		method = "LBKeogh-PrunedDTW";		// Method type in finding the best window
