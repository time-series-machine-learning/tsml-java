...
//            classifier.setCheckpointDirPath("checkpoints");
    ...
    public enum Config implements EnumBasedConfigurer<ProximityTree> {
        ...
        PT_R1_QUICK() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R1.configureFromEnum(proximityTree);
                proximityTree.setEarlyAbandonDistances(true);
                proximityTree.setImprovedExemplarCheck(true);
                return proximityTree;
            }
        },
        PT_R5_QUICK() {
        ...
        PT_R1_SQUICK() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R1.configureFromEnum(proximityTree);
                proximityTree.setReduceSplitTestSize(true);
                return proximityTree;
            }
        },
        PT_R5_SQUICK() {
        ...
        PT_R5_CHI() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setEarlyAbandonDistances(true);
                proximityTree.setPartitionScorer(new ChiSquaredGain());
                return proximityTree;
            }
        },
        PT_R5_IG() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setEarlyAbandonDistances(true);
                proximityTree.setPartitionScorer(new InfoGain());
                return proximityTree;
            }
        },
        PT_R5_GG() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setEarlyAbandonDistances(true);
                proximityTree.setPartitionScorer(new GiniGain());
                return proximityTree;
            }
        },
        PT_R5_IE() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setEarlyAbandonDistances(true);
                proximityTree.setPartitionScorer(new InfoEntropy());
                return proximityTree;
            }
        },
        PT_R5_O() {
            @Override public <B extends ProximityTree> B configureFromEnum(B  proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setDistanceFunctionSpaceBuilders(newArrayList(
                        ParamSpaceBuilder.DTW,
                        ParamSpaceBuilder.DDTW,
                        ParamSpaceBuilder.LCSS,
                        ParamSpaceBuilder.ERP
        ...
        PT_R5_I() {
            ...
            public <B extends ProximityTree> B configureFromEnum(B proximityTree) {
                proximityTree = PT_R5.configureFromEnum(proximityTree);
                proximityTree.setRandomIntervals(true);
                proximityTree.setMinIntervalSize(3);
                return proximityTree;
            }
        },
        PT_R10_I() {
