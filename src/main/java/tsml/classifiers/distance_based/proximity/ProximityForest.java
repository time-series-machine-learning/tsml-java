...
//            tree.setLogger(logger);
    ...
    public void setProximityTreeFactory(
            final Factory<ProximityTree> proximityTreeFactory) {
        Assert.assertNotNull(proximityTreeFactory);
        this.proximityTreeFactory = proximityTreeFactory;
    }
