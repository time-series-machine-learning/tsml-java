...
public class Indexer extends BaseTrainableTransformer {
    ...
    public static class IndexedInstance implements Instance {
        ...
        @Override public Attribute attribute(final int index) {
            return instance.attribute(index);
        }

        @Override public Attribute attributeSparse(final int indexOfIndex) {
        ...
        @Override public void deleteAttributeAt(final int position) {
        ...
        @Override public int index(final int position) {
            return instance.index(position);
        }

        @Override public void insertAttributeAt(final int position) {
            instance.insertAttributeAt(position);
        }

        @Override public boolean isMissing(final int attIndex) {
            return instance.isMissing(attIndex);
        }

        @Override public boolean isMissingSparse(final int indexOfIndex) {
        ...
        @Override public void setValue(final int attIndex, final double value) {
            instance.setValue(attIndex, value);
        }

        @Override public void setValueSparse(final int indexOfIndex, final double value) {
            instance.setValueSparse(indexOfIndex, value);
        }

        @Override public void setValue(final int attIndex, final String value) {
            instance.setValue(attIndex, value);
        }
        ...
        @Override public Instances relationalValue(final int attIndex) {
        ...
        @Override public String stringValue(final int attIndex) {
        ...
        @Override public double value(final int attIndex) {
            return instance.value(attIndex);
        }

        @Override public double valueSparse(final int indexOfIndex) {
        ...
        @Override public IndexedInstance copy() {
