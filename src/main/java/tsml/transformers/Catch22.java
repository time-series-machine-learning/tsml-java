...
public class Catch22 implements Transformer {
    ...
    public double getSummaryStatByIndex(int summaryStatIndex, int seriesIndex, double[] series) throws Exception {
        ...
        switch(summaryStatIndex){
            case 0: return histMode5DN(idxSeries, idxMin, idxMax);
            case 1: return histMode10DN(idxSeries, idxMin, idxMax);
            case 2: return binaryStatsMeanLongstretch1SB(idxSeries, idxMean);
            case 3: return outlierIncludeP001mdrmdDN(idxOutlierSeries);
            case 4: return outlierIncludeN001mdrmdDN(idxOutlierSeries);
            case 5: return f1ecacCO(idxAC);
            case 6: return firstMinacCO(idxAC);
            case 7: return summariesWelchRectArea51SP(idxSeries, idxFFT);
            case 8: return summariesWelchRectCentroidSP(idxSeries, idxFFT);
            case 9: return localSimpleMean3StderrFC(idxSeries);
            case 10: return trev1NumCO(idxSeries);
            case 11: return histogramAMIeven25CO(idxSeries, idxMin, idxMax);
            case 12: return autoMutualInfoStats40GaussianFmmiIN(idxAC);
            case 13: return hrvClassicPnn40MD(idxSeries);
            case 14: return binaryStatsDiffLongstretch0SB(idxSeries);
            case 15: return motifThreeQuantileHhSB(idxSeries);
            case 16: return localSimpleMean1TauresratFC(idxSeries, idxAC);
            case 17: return embed2DistTauDExpfitMeandiffCO(idxSeries, idxAC);
            case 18: return fluctAnal2Dfa5012LogiPropR1SC(idxSeries);
            case 19: return fluctAnal2Rsrangefit501LogiPropR1SC(idxSeries);
            case 20: return transitionMatrix3acSumdiagcovSB(idxSeries, idxAC);
            case 21: return periodicityWangTh001PD(idxSeries);
