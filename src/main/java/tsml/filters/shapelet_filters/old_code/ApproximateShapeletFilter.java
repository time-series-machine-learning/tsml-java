...
public class ApproximateShapeletFilter extends ShapeletFilter {
    /**
     ...
     */
    public ApproximateShapeletFilter(){
        super();
     ...
     */
    public ApproximateShapeletFilter(int k){
        super(k);
        seriesSampleLevel = 50;
        dataPointsSize = 50;
    }
     ...
     */
    public ApproximateShapeletFilter(int k, int minShapeletLength, int maxShapeletLength){
     ...
     */
    public ApproximateShapeletFilter(int k, int minShapeletLength, int maxShapeletLength, ShapeletQualityChoice qualityChoice){
    ...
    private Instances sampleInstances(Instances data){
        if(seriesSampleLevel == 100){
            ...
            try {
                ...
                Logger.getLogger(ApproximateShapeletFilter.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String[] args){        
        ...
        ApproximateShapeletFilter ast = new ApproximateShapeletFilter();
