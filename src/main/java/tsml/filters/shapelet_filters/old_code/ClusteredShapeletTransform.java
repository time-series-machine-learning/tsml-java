 ...
 * 
 */
    public ClusteredShapeletTransform(ShapeletFilter shapes, int n){
        st=shapes;
...
//       System.out.println("Clustering shapelets: "+this.noClust);
       ...
       {
           shapeletSet[i] = allShapelets.get(i).getUnivariateShapeletContent();
       }
    ...
    public void setShapeletTransform(ShapeletFilter s){
        st=s;
    }
...
//            System.out.println("******************************************");
            ...
            cout.flush();
            double[] con = s.getUnivariateShapeletContent();
