 ...
 /* Returns probability distribution for each instance with no randomisation  
    */
    ...
    public static void trainTestPrint(Classifier classifier, Instances[] trainAndTestData, int seed) throws Exception {
        ...
        memoryWatcher.stop();
        System.out.println();
        System.out.println("train time: " + timer.elapsedTimeStopped());
...
//        GcFinalization.awaitFullGc();
        ...
        System.out.println("test time: " + timer.elapsedTimeStopped());
        ...
        overallTimer.stop();
        System.out.println();
        System.out.println("overall time: " + overallTimer.elapsedTimeStopped());
