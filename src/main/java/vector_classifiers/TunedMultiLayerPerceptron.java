...
Many hidden layer version:
1. number of hidden layers: 6 values, 1,2,3,4,5,6
2. number of nodes per layer: 4 values, data dependent, same for all hidden layers: 
Embedded in m_hiddenLayers. Values either 
"a"=(m_numAttributes + m_numClasses) / 2;
"i"= m_numAttributes;
"o" = m_numClasses;
"t" = m_numAttributes + m_numClasses;
3. Learning rate: 5 values, data independent, variable m_learningRate
1,1/4,1/8,1/32,1/128
4. Momentum: 4 values
0,1/4,1/2,3/4
5. m_decay 2 values: either true or false

total models = 6*4*5*4*2=1024
 ...
 * @author ajb
 */
public class TunedMultiLayerPerceptron extends MultilayerPerceptron implements SaveParameterInfo,TrainAccuracyEstimate,SaveEachParameter,ParameterSplittable{
    ...
    public TunedMultiLayerPerceptron(){
        super();
        rng=new Random();
        seed=0;
...
//TO DO: Write the other stats        
    ...
    public final void setStandardParaSearchSpace(int m){
        ...
        paraSpace1=new String[24]; //# hidden layers imbedded in the structure
        ...
        paraSpace1[8]="a,a,a";// =(m_numAttributes + m_numClasses) / 2;
        paraSpace1[9]="i,i,i";//=m_numAttributes;
        paraSpace1[10]="o,o,o";// = m_numClasses;
        paraSpace1[11]="t,t,t";//= m_numAttributes + m_numClasses;    
        paraSpace1[12]="a,a,a,a";// =(m_numAttributes + m_numClasses) / 2;
        paraSpace1[13]="i,i,i,i";//=m_numAttributes;
        paraSpace1[14]="o,o,o,o";// = m_numClasses;
        paraSpace1[15]="t,t,t,t";//= m_numAttributes + m_numClasses;    
        paraSpace1[16]="a,a,a,a,a";// =(m_numAttributes + m_numClasses) / 2;
        paraSpace1[17]="i,i,i,i,i";//=m_numAttributes;
        paraSpace1[18]="o,o,o,o,o";// = m_numClasses;
        paraSpace1[19]="t,t,t,t,t";//= m_numAttributes + m_numClasses;    
        paraSpace1[20]="a,a,a,a,a,a";// =(m_numAttributes + m_numClasses) / 2;
        paraSpace1[21]="i,i,i,i,i,i";//=m_numAttributes;
        paraSpace1[22]="o,o,o,o,o,o";// = m_numClasses;
        paraSpace1[23]="t,t,t,t,t,t";//= m_numAttributes + m_numClasses;    
        paraSpace2=new double[]{1.0,1/4.0,1/8.0,1/32.0,1/128.0};//Learning rate
        paraSpace3=new double[]{0,1/4.0,1/2.0,3/4.0};//momentum
        ...
        for(String p1:paraSpace1){//Number of hidden nodes
            for(double p2:paraSpace2){//learning rate
                for(double p3:paraSpace3){//Num trees
                    for(boolean p4:paraSpace4){//Decay
                        count++;
    ...
    //                                System.out.println("SKIPPING THIS FOLD");
                        ...
                        TunedMultiLayerPerceptron model = new TunedMultiLayerPerceptron();
...
//        jamesltests();
        TunedMultiLayerPerceptron t=new TunedMultiLayerPerceptron();
        t.debug=true;
        ...
        try{
           ...
           Instances all=ClassifierTools.loadData("C:\\Users\\ajb\\Dropbox\\UCI Problems\\"+dset+"\\"+dset);        
            Instances[] split=InstanceTools.resampleInstances(all,1,0.5);
                TunedMultiLayerPerceptron rf=new TunedMultiLayerPerceptron();
                rf.debug(true);
